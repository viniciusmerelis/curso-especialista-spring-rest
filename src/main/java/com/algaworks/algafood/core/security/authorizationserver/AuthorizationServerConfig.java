...
public class AuthorizationServerConfig {
    ...
    public RegisteredClientRepository registeredClientRepository(PasswordEncoder passwordEncoder) {
        RegisteredClient clientCredential = RegisteredClient
                .withId("1")
        ...
        RegisteredClient algafoodWeb = RegisteredClient
                ...
                .tokenSettings(TokenSettings.builder()
                        ...
                        .build())
                .redirectUri("http://172.20.176.1:8080")
        ...
        return new InMemoryRegisteredClientRepository(Arrays.asList(clientCredential, algafoodWeb, foodanalytics));
    }
