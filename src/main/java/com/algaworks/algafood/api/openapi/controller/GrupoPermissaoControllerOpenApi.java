...
public interface GrupoPermissaoControllerOpenApi {
    ...
    void associarPermissao(@ApiParam(value = "ID do grupo", example = "1", required = true) Long grupoId,
    ...
    void desassociarPermissao(@ApiParam(value = "ID do grupo", example = "1", required = true) Long grupoId,
                              @ApiParam(value = "ID da permissão", example = "1", required = true) Long permissaoId);
}
